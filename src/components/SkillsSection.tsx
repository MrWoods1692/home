              ...
              <div className="flex flex-wrap gap-2">
                {skill.items.map((item, i) => {
                  ...
                  const borderColors = [
                    ...
                    "#ff9f43", "#0abde3", "#10ac84", "#ee5a24"
                  ];
                  const borderColor = borderColors[(idx * 7 + i * 3) % borderColors.length];
                  return (
                    <Badge key={i} variant="secondary" className="hand-border bg-transparent hover:bg-primary hover:text-primary-foreground transition-all px-3 py-1" style={{ borderColor }}>
